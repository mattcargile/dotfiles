...
begin {
    ...
    $env:CARAPACE_EXCLUDES = 'ls,bat,rg,fd,gh,chezmoi,glow,bb,dotnet,winget,get-env,set-env,unset-env,ov,sudo' # Exclude completions that conflict or already exist from software creator.
