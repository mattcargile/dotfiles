...
New-Alias -Name 'gxeob' -Value 'Get-DbaXEObject'
New-Alias -Name 'gxest' -Value 'Get-DbaXEStore'
New-Alias -Name 'gxese' -Value 'Get-DbaXESession'
New-Alias -Name 'rxese' -Value 'Remove-DbaXESession'
New-Alias -Name 'nxese' -Value 'New-DbaXESession'
New-Alias -Name 'epxese' -Value 'Export-DbaXESession'
New-Alias -Name 'saxese' -Value 'Start-DbaXESession'
New-Alias -Name 'spxese' -Value 'Stop-DbaXESession'
New-Alias -Name 'wcxese' -Value 'Watch-DbaXESession'
