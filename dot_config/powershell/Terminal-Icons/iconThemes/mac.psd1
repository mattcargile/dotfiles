    ...
    Types = @{
        Directories = @{
            ...
            WellKnown = @{
                ...
                'onedrive - general health system'   = 'nf-md-microsoft_onedrive'
                'general health system'              = 'nf-md-microsoft_onedrive'
        ...
        Files       = @{
            ...
            '.pks'                  = 'nf-dev-database'
            '.pkb'                  = 'nf-dev-database'
            '.accdb'                = 'nf-md-microsoft_access'
            '.laccdb'               = 'nf-md-microsoft_access'
            '.mdb'                  = 'nf-md-microsoft_access'
            '.sqlite'               = 'nf-dev-sqllite'
            '.pgsql'                = 'nf-dev-database'
            '.postgres'             = 'nf-dev-postgresql'
            '.psql'                 = 'nf-dev-database'
            '.db'                   = 'nf-dev-database'
            '.mdf'                  = 'nf-dev-microsoftsqlserver'
            '.ndf'                  = 'nf-dev-microsoftsqlserver'
            '.ldf'                  = 'nf-dev-microsoftsqlserver'
            '.sqlplan'              = 'nf-dev-microsoftsqlserver'
            '.rdl'                  = 'nf-dev-microsoftsqlserver'
            '.ispac'                = 'nf-dev-microsoftsqlserver'
            '.bak'                  = 'nf-dev-microsoftsqlserver'
            '.pesession'            = 'nf-md-database_plus_outline'
            '.trc'                  = 'nf-md-database_plus_outline'
            ...
            # Viz
            '.pbix'                 = 'nf-md-file_chart'
            '.twbx'                 = 'nf-md-file_chart'

            # Misc Binary
            '.bin'                  = 'nf-oct-file_binary'
            '.dmp'                  = 'nf-oct-file_binary'
            '.mdmp'                 = 'nf-oct-file_binary'
